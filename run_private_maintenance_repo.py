...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        scs_path = os.path.join(os.path.dirname(__file__), "studies", "Maintenance", "scenarios")
        # Base Examples IRS only
        # ----------------------

        log_level = "info"
        cc = os.path.join(scs_path, "const_Maintenance_infra.csv")
        sc = os.path.join(scs_path, "scenario_maintenance_vs_nomaintenance.csv")
